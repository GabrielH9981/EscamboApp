...
#gerar usuários falsos para teste
gem 'faker', '~> 1.6.5'

#Pundit provides a set of helpers which guide you in leveraging regular Ruby classes and object oriented design patterns to build a simple, robust and scalable authorization system.s
gem "pundit", '1.1.0'
...
# Animate CSS
gem 'rails-assets-animate-css', '3.5.2', source: 'https://rails-assets.org'

#This library provides integration of the money gem with Rails.
gem 'money-rails', '~>1.11.0'
#negócio das imagens la
gem 'paperclip', '~>5.0.0'
